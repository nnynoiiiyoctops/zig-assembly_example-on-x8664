...
pub fn main() !void {
  ...
  // : .{ .rcx = true, .r11 = true } ); //Это лишь пример
                                        ...
                                        //Например этот "clobbers" говорит что после нашего кода поменяются регистры rcx и r11
  ...
  asm volatile(
      ...
      : .{ .rax = true }  //Тут перечисляются решистры которые будут изменены. Но изменены из вне
